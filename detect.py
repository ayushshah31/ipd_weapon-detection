...
def run(
    ...
    # Directories
    # save_dir = increment_path(Path(savePath), exist_ok=exist_ok)  # increment run
    ...
    for path, im, im0s, vid_cap, s in dataset:
        ...
        for i, det in enumerate(pred):  # per image
            ...
            p = Path(p)  # to Path
            save_path = f'{save_dir}/{fileName}.jpg'  # im.jpg
            save_path = increment_path(Path(save_path), exist_ok=exist_ok)  # increment run
